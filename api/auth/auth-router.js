...
const userMw = require("./auth-middleware");
...
router.post(
  "/register",
  userMw.checkLoginPayload,
  userMw.sifreGecerlimi,
  userMw.usernameBostami,
  async (req, res, next) => {
    try {
      ...
      const insertedUser = await userModel.ekle(user);
